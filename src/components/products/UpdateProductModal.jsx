...
function UpdateProductModal(props) {
    ...
    useEffect(() => {
        targetItem && getData(targetItem.id);
    }, [targetItem]);
    ...
    const initData = () => {
        ...
        setBoostFrequency(data.boostFrequency);
        setCacheCapacity(data.cacheCapacity);
        setMemoryCapacity(data.memoryCapacity);
        setMemoryType(data.memoryType);
        setMemoryBus(data.memoryBus);
        setMaxMemoryCapacity(data.maxMemoryCapacity);
        setStorage(data.storage);
        setDisplaySize(data.displaySize);
        setResolution(data.resolution);
        setRefreshRate(data.refreshRate);
        setColorGamut(data.colorGamut);
        setPanelType(data.panelType);
        setTouchScreen(data.touchScreen);
        setGraphicsCard(data.graphicsCard);
        setSoundTechnology(data.soundTechnology);
        setWirelessConnectivity(data.wirelessConnectivity);
        setSdCard(data.sdCard);
        setWebcam(data.webcam);
        setCoolingFan(data.coolingFan);
        setMiscFeature(data.miscFeature);
        setBacklitKeyboard(data.backlitKeyboard);
        setDimensionWeight(data.dimensionWeight);
        setMaterial(data.material);
        setBatteryCapacity(data.batteryCapacity);
        setChargerCapacity(data.chargerCapacity);
        setOs(data.os);
        ...
        data && (
            <Modal show={show} onHide={handleClose} size="lg">
                ...
                <Modal.Body>
                    ...
                    <Form.Group
                        className="mb-3"
                        controlId="formMaxMemoryCapacity"
                    >
                    ...
                    >
                        ...
                        <Form.Control
                            ...
                            onChange={e =>
                                setWirelessConnectivity(e.target.value)
                            }
                        />
                    </Form.Group>
